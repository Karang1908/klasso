...
export default function LoginPage() {
  ...
  return <main className="safe-t mx-auto flex min-h-dvh max-w-6xl flex-col justify-center px-6 py-10">
    ...
    <div className="grid items-center gap-10 md:grid-cols-2 lg:gap-20">
      ...
      <Card className="p-6 sm:p-8"><h2 className="page-heading">{mode === "up" ? "Make room for a better day." : mode === "forgot" ? "Let’s get you back in." : "Welcome back."}</h2><p className="page-subtitle mb-6">{mode === "up" ? "Create your own college workspace." : mode === "forgot" ? "We’ll email you a link to reset your password." : "Your college day is waiting for you."}</p>
        ...
        <button className="section-link mt-4 w-full justify-center" onClick={() => { setMode(mode === "in" ? "up" : "in"); setError(null); setNotice(null); }}>{mode === "in" ? "New here? Create an account" : "Back to sign in"}</button>
